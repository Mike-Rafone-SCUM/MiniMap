...
namespace ScumMiniMap {
    ...
    public static class Localization {
        ...
        public static readonly Dictionary<string, string> StringsEn = new Dictionary<string, string>(StringComparer.Ordinal) {
            ...
            { "ShowTowns", "Show towns" },
            { "ShowFarms", "Show farms" },
            ...
            { "CustomMapDimensions", "Image: {0} x {1} pixels. Apply this map?" },
            { "CustomMapTooSmall", "Image must be at least 1024 x 1024 pixels." },
            { "CustomMapConfirmTitle", "Custom Map" },
        ...
        public static readonly Dictionary<string, string> StringsEsAr = new Dictionary<string, string>(StringComparer.Ordinal) {
            ...
            { "ShowCities", "Mostrar ciudades" },
            { "ShowTowns", "Mostrar pueblos" },
            { "ShowFarms", "Mostrar granjas" },
            ...
            { "CustomMapDimensions", "Imagen: {0} x {1} pixeles. Aplicar este mapa?" },
            { "CustomMapTooSmall", "La imagen debe tener al menos 1024 x 1024 pixeles." },
            { "CustomMapConfirmTitle", "Mapa personalizado" },
