...
Add-Type -Path @((Join-Path $PSScriptRoot 'UpdateService.cs'), (Join-Path $PSScriptRoot 'RoadRouter.cs'), (Join-Path $PSScriptRoot 'Localization.cs'), (Join-Path $PSScriptRoot 'MiniMap.cs'), (Join-Path $PSScriptRoot 'Overlay.cs'), (Join-Path $PSScriptRoot 'Zones.cs'), (Join-Path $PSScriptRoot 'Search.cs')) -ReferencedAssemblies System.Windows.Forms,System.Drawing
$miniWindow = [ScumMiniMap.MapWindow]::new($PSScriptRoot, $true)
try {
