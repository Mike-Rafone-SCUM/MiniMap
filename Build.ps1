...
if ($Increment -or $Version) {
    ...
    $miniCsText = $miniCsText -replace 'public static readonly Version CurrentVersion\s*=\s*new Version\([^)]+\);', "public static readonly Version CurrentVersion = new Version(VersionString + ".0");"
